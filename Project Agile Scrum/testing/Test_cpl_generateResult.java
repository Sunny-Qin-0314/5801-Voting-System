...
//    System.out.println(results.get(0).get("a")); // 1
//    System.out.println(results.get(0).get("b")); // null
//
//    System.out.println(results.get(1).get("c")); // 2
//    System.out.println(results.get(1).get("d")); // 1
//    System.out.println(results.get(1).get("e")); // null
//
//    System.out.println(results.get(2).get("f")); // null
//    System.out.println(results.get(2).get("g")); // null
//    System.out.println(results.get(2).get("h")); // 1
//    System.out.println(results.get(2).get("i")); // 2
//    System.out.println(results.get(2).get("j")); // 3

    if(results.get(0).get("a") == 1 &&
            results.get(0).get("b") == null &&
            results.get(1).get("c") == 2  &&
            results.get(1).get("d") == 1 &&
            results.get(1).get("e") == null &&
            results.get(2).get("f") == null &&
            results.get(2).get("g") == null &&
            results.get(2).get("h") == 1 &&
            results.get(2).get("i") == 2 &&
            results.get(2).get("j") == 3
    )
...
//    System.out.println(results2.get(2).get("j"));
    ...
    if(results2.get(0).get("a") == null &&
            results2.get(0).get("b") == null &&

            results2.get(1).get("c") == 2  &&
            results2.get(1).get("d") == 1 &&
            results2.get(1).get("e") == null &&

            results2.get(2).get("f") == null &&
            results2.get(2).get("g") == null &&
            results2.get(2).get("h") == 1 &&
            results2.get(2).get("i") == 2 &&
            results2.get(2).get("j") == 3
    )
      System.out.println("true");
    else System.out.println("false");
